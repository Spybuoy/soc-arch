...
using std::cout;
using std::endl;
void SHA(const unsigned char * Input_add,unsigned int * chunk_add_old,unsigned int * chunk_len_old,unsigned int * chunk_add_new,unsigned int * chunk_len_new,char* SHA)
{	
    int i=0;
    int count=0;
    int time=1;
